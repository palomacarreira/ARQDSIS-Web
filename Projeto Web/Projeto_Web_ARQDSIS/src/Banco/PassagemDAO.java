...
public class PassagemDAO extends MysqlConnect{
	   ...
	   {		 
	    ...
	    + " values (?,?,?,?,?,?,?,?)";       
	         ...
	         if(passagemTO.getFormaPagamento().equals("Cr�dito"))
	         {
	   ...
	   public PassagemTO passagensVendidas(String codigo)
	   {
	      ...
	      public ArrayList<PassagemTO> recuperaPassagem(String origem, String destino){
	    	  ArrayList<PassagemTO> list = new ArrayList<PassagemTO>();
	    	  PassagemTO passagem = null;
	    	  try {
				String sql = "SELECT * FROM tabelaPassagem a, tabelaVoo b WHERE a.codigoVoo = b.codigo AND b.origem = ? AND b.destino = ?";
				st= conn.prepareStatement(sql);
				...
				{
					passagem = new PassagemTO();
					passagem.setDataPartida(resultSet.getString("dataPartida"));
					passagem.setHoraPartida(resultSet.getString("horaPartida"));
					passagem.setValor(resultSet.getDouble("valor"));
					passagem.setDestino(resultSet.getString("destino"));
